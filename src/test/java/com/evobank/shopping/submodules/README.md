...
### Cobertura del caso de uso: Crear Carrito
![Cobertura de crear carrito](https://github.com/gotorresevo/proyecto-base-spring-boot/raw/master/assets/TestCartCreatorUseCase.png "Diagrama de secuencia de la arquitectura mostrando la cobertura de la prueba")
