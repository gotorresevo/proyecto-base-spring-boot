...
class UpdateProductCommandHandlerTest extends ProductsModuleUnitTestCase {
    private UpdateProductCommandHandler handler;
    @BeforeEach
    protected void setUp() {
        super.setUp();
        handler = new UpdateProductCommandHandler(new ProductUpdater(repository, eventBus, factory));
    }
